...
export function useCourses(filters?: Record<string, any>) {
  ...
  return { courses, total, loading, error, refetch: fetchCourses, createCourse, updateCourse, deleteCourse }
}
...
export function useEnrollments() {
  ...
  return { enrollments, loading, error, refetch: fetchEnrollments, enrollCourse }
}
