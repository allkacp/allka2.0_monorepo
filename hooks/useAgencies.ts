...
export function useAgencies(filters?: Record<string, any>) {
  ...
  const updateAgency = useCallback(async (id: string, data: any) => {
  ...
  return { agencies, total, loading, error, refetch: fetchAgencies, createAgency, updateAgency, deleteAgency }
}
