    ...
    tasks: [
      {
        ...
        task_type: "execution",
        description:
          "Reunião de briefing com o cliente para entender objetivos, histórico de campanhas e concorrentes. Diagnóstico do ambiente atual de anúncios (contas, pixels, histórico).",
        objective:
          "Coletar todas as informações necessárias para estruturar a estratégia de campanhas e identificar problemas críticos no ambiente atual.",
        estimated_hours: 2,
        ...
        execution_rules: [
          "Verificar se os acessos necessários foram compartilhados antes de iniciar",
          "Realizar reunião de briefing (vídeo ou formulário) antes de acessar qualquer conta",
          "Documentar: objetivo das campanhas, público-alvo, verba, histórico e concorrentes",
          "Diagnosticar: pixel instalado, configurações da conta, histórico de campanhas anteriores",
          "Registrar tudo no documento de entrega antes de avançar para T02",
        ],
        sort_order: 1,
        phase: "PA0001-E01",
      },
      {
        ...
        task_type: "execution",
        description:
          "Estruturação e ativação das campanhas conforme estratégia definida no briefing: segmentação de público, criação de conjuntos de anúncios, seleção de criativos e definição de orçamentos.",
        objective:
          "Ter as campanhas configuradas, revisadas e ativas dentro das plataformas solicitadas, prontas para monitoramento.",
        estimated_hours: 3,
        ...
        requires_access: true,
        execution_rules: [
          "Estruturar campanhas conforme objetivo: tráfego, conversão, lead, awareness",
          "Configurar segmentação de público de acordo com o briefing",
          "Definir orçamento diário/total conforme verba informada",
          "Revisar todo o conjunto antes de ativar — não ativar com configurações incompletas",
          "Confirmar que o pixel/tag está disparando corretamente antes de ativar conversões",
        ],
        sort_order: 2,
        phase: "PA0001-E01",
      },
      {
        ...
        task_type: "execution",
        description:
          "Análise semanal de métricas das campanhas ativas. Identificação de oportunidades de melhoria e realização de ajustes de segmentação, criativos e lances.",
        objective:
          "Manter as campanhas otimizadas ao longo do mês, maximizando o resultado dentro da verba disponível.",
        estimated_hours: 2,
        ...
        requires_access: true,
        execution_rules: [
          "Analisar métricas: CTR, CPC, CPA, ROAS, frequência e relevância",
          "Identificar anúncios com baixo desempenho e pausar ou ajustar",
          "Testar variações de segmentação ou criativos quando CTR estiver abaixo de 1%",
          "Registrar os ajustes realizados no relatório semanal",
          "Não realizar alterações estruturais nas campanhas sem comunicar o líder",
        ],
        sort_order: 3,
        phase: "PA0001-E02",
      },
      {
        ...
        task_type: "execution",
        description:
          "Compilação dos dados de desempenho do mês em relatório estruturado, com análise de resultados, comparativo com mês anterior e recomendações para o próximo período.",
        objective:
          "Entregar relatório mensal completo ao cliente com os resultados das campanhas, análise de performance e recomendações estratégicas.",
        estimated_hours: 2,
        default_deadline_days: 2,
        default_priority: "medium",
        complexity: "intermediate",
        ...
        execution_rules: [
          "Compilar dados dos dashboards das plataformas usadas no mês",
          "Incluir: investimento total, impressões, cliques, CTR, conversões, CPA, ROAS",
          "Comparar com período anterior quando disponível",
          "Incluir seção de recomendações para o próximo mês",
          "Não entregar relatório sem análise interpretativa — números sem contexto não são aceitos",
        ],
        sort_order: 4,
        phase: "PA0001-E03",
      },
