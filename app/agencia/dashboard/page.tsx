    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-xl border border-slate-100 p-4 shadow-sm">
          ...
          <p className="text-xs text-slate-400 mt-1">{profile.totalProjects} total</p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-100 p-4 shadow-sm">
          ...
          <p className="text-xs text-slate-400 mt-1">{profile.totalTasks} total</p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-100 p-4 shadow-sm">
          ...
          <p className="text-2xl font-bold text-slate-900">{planInfo.discount}%</p>
        ...
        <div className="bg-white rounded-xl border border-slate-100 p-4 shadow-sm">
          ...
          <p className="text-2xl font-bold text-slate-900">{fmtBRL(profile.currentMrr)}</p>
        ...
        <div className="bg-white rounded-xl border border-slate-100 shadow-sm">
          ...
          <div className="divide-y divide-slate-50">
            {activeTasks.length === 0 ? (
              <p className="px-5 py-8 text-sm text-slate-400 text-center">Nenhuma tarefa ativa</p>
            ) : (
                ...
                return (
                  <div key={task.id} className="px-5 py-3 flex items-start justify-between gap-2">
                    ...
                    <div className="shrink-0 text-right">
                      ...
                      <p className="text-xs text-slate-400 mt-1">até {fmtDate(task.dueDate)}</p>
                    </div>
                  </div>
                );
              })
