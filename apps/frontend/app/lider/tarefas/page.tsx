...
export default function LiderTarefasPage() {
  ...
  return (
    ...
    <div className="relative h-full min-h-0 flex flex-col">
      {/* Tela Slide (EmbeddedSlideScreen) — precisa ficar DENTRO do
          container relative acima. */}
      <TarefaDetailDrawer
        tarefa={drawerTask}
        open={drawerOpen}
      ...
      <StandardPageBanner
        ...
        actions={
          <>
            ...
            <PinToTrayButton id="page-leader-tarefas" label={pageTitle} icon={PlayCircle} path="/leader/tarefas" />
          </>
        }
      />
      </div>
