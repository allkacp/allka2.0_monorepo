    ...
    <div className="relative h-full min-h-0 flex flex-col" ref={pageRef}>
      ...
      <StandardPageBanner
        ...
        actions={<>
          ...
          <PinToTrayButton id="page-campanhas" label="Campanhas e Promoções" icon={Megaphone} path="/admin/campanhas-indicacao" />
        </>}
      />
      </div>
                    ...
                    <tbody>
                      {reportItems.map((item, idx) => {
                        ...
                        return (
                          ...
                          >
                            <td data-rotulo="Nome / Código" className="px-2 py-1.5 font-medium text-slate-700 dark:text-slate-200 max-w-[180px] truncate">
                              {item.name}
                            </td>
                            <td data-rotulo="Tipo" className="px-2 py-1.5 text-slate-500 dark:text-slate-400">
                              {item.kind}
                            </td>
                            <td data-rotulo="Status" className="px-2 py-1.5">
                              <span
                            ...
                            <td data-rotulo="Conta" className="px-2 py-1.5 text-slate-400 dark:text-slate-500">
                              {item.accountType}
                            </td>
                            <td
                            ...
                            <td data-rotulo="Usos" className="px-2 py-1.5 text-right tabular-nums text-slate-600 dark:text-slate-300">
                            ...
                            <td data-rotulo="Taxa Conv." className="px-2 py-1.5 text-right tabular-nums font-semibold text-violet-600">
                              {item.rate}%
                            </td>
                            <td data-rotulo="Receita" className="px-2 py-1.5 text-right tabular-nums text-slate-600 dark:text-slate-300">
                              R$ {item.revenue.toLocaleString("pt-BR")}
                            </td>
                            <td data-rotulo="Comissão" className="px-2 py-1.5 text-right tabular-nums font-semibold text-amber-600">
