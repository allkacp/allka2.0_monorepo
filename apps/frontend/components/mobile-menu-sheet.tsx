...
const navigationConfig = {
  ...
  agencias: [
    ...
    { name: "Clientes", href: "/agency/clientes", icon: Building2, badge: "15" },
    { name: "Projetos", href: "/agency/projetos", icon: FolderOpen, badge: "24" },
    { name: "Equipe", href: "/agency/equipe", icon: Users, badge: "8" },
    { name: "Programa", href: "/agency/programa", icon: Award },
    { name: "Lideradas", href: "/agency/lideradas", icon: TrendingUp, badge: "5" },
    { name: "Financeiro", href: "/agency/financeiro", icon: Wallet },
    { name: "Allkademy", href: "/allkademy", icon: BookOpen },
    { name: "Configurações", href: "/agency/configuracoes", icon: Settings },
  ],
  nomades: [
