...
const navigationConfig = {
  empresas: {
    company: [
      ...
      { name: "Pagamentos", href: "/company/faturas", icon: CreditCard, color: "from-orange-500 to-orange-600" },
  ...
  admin: [
    ...
    { name: "Allkademy", href: "/admin/allkademy", icon: BookOpen, color: "from-cyan-500 to-cyan-600" },
    {
      name: "Administração",
      icon: Shield,
