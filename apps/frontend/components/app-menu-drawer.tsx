...
const navigationConfig = {
  ...
  agencias: [
    { name: "Dashboard", href: "/agency/dashboard", icon: LayoutDashboard, color: "from-blue-500 to-blue-600" },
    { name: "Perfil", href: "/agency/perfil", icon: Building2, color: "from-indigo-500 to-indigo-600" },
    {
      name: "Clientes",
    ...
    { name: "Equipe", href: "/agency/equipe", icon: Users, badge: "8", color: "from-pink-500 to-pink-600" },
    { name: "Programa", href: "/agency/programa", icon: Award, color: "from-amber-500 to-amber-600" },
    {
      name: "Lideradas",
      href: "/agency/lideradas",
      icon: TrendingUp,
      badge: "5",
      color: "from-orange-500 to-orange-600",
    },
    { name: "Financeiro", href: "/agency/financeiro", icon: Wallet, color: "from-emerald-500 to-emerald-600" },
    { name: "Allkademy", href: "/allkademy", icon: BookOpen, color: "from-cyan-500 to-cyan-600" },
    { name: "Configurações", href: "/agency/configuracoes", icon: Settings, color: "from-slate-500 to-slate-600" },
  ],
  nomades: [
    { name: "Dashboard", href: "/nomad/dashboard", icon: LayoutDashboard, color: "from-blue-500 to-blue-600" },
    {
  ...
  parceiro: [
    { name: "Dashboard", href: "/partner/dashboard", icon: Home, color: "from-blue-500 to-blue-600" },
    { name: "Agências", href: "/partner/agencias", icon: Building2, color: "from-purple-500 to-purple-600" },
    { name: "Projetos", href: "/partner/projetos", icon: FolderOpen, color: "from-green-500 to-green-600" },
    { name: "Comissões", href: "/partner/comissoes", icon: TrendingUp, color: "from-amber-500 to-amber-600" },
    { name: "Saques", href: "/partner/saques", icon: Wallet, color: "from-emerald-500 to-emerald-600" },
  ],
  lider: [
    { name: "Dashboard", href: "/leader/dashboard", icon: Home, color: "from-blue-500 to-blue-600" },
    { name: "Qualificação", href: "/leader/qualificacao", icon: Award, color: "from-amber-500 to-amber-600" },
    { name: "Tarefas", href: "/leader/tarefas", icon: CheckSquare, color: "from-purple-500 to-purple-600" },
    { name: "Devolvidas", href: "/leader/devolvidas", icon: History, color: "from-orange-500 to-orange-600" },
    { name: "Histórico", href: "/leader/historico", icon: BarChart3, color: "from-slate-500 to-slate-600" },
    { name: "Perfil", href: "/leader/perfil", icon: UserCheck, color: "from-cyan-500 to-cyan-600" },
  ],
  admin: [
