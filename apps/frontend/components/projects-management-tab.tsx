...
export function ProjectsManagementTab({ company }: ProjectsManagementTabProps) {
  ...
  const [quickStatusFilter, setQuickStatusFilter] = useState<string | null>(
    null,
  );
            ...
            .map(([statusKey, { label, dot }]) => {
              ...
              return (
                <button
                  key={statusKey}
                  onClick={() =>
                    setQuickStatusFilter(isActive ? null : statusKey)
                  }
                  className={`flex items-center gap-1.5 h-9 px-3 rounded-lg border text-xs font-medium transition-colors ${
                    isActive
                      ? "bg-slate-900 text-white border-slate-900 shadow-sm"
                ...
                >
                  ...
                  <span>{label}</span>
                  <span
                    className={`font-bold ${isActive ? "text-white" : "text-slate-800"}`}
                  >
                    {count}
                  </span>
                </button>
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between pt-2">
            <p className="text-xs text-slate-500">
              ...
              {Math.min(startIndex + itemsPerPage, totalProjects)} de{" "}
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="h-8 w-8 flex items-center justify-center rounded-lg border border-slate-200 text-slate-500 hover:bg-slate-50 disabled:opacity-40 disabled:cursor-not-allowed text-xs"
              >
                ‹
              </button>
          ...
          <div className="px-6 py-5 space-y-5 overflow-y-auto flex-1">
              ...
              <div className="space-y-2">
                ...
                <label className="flex items-start gap-3 rounded-lg border border-slate-200 bg-white px-3.5 py-3 cursor-pointer hover:border-emerald-300 hover:bg-emerald-50/30 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">
                      Lista de produtos disponíveis (dados de contratação serão
                      resetados)
                    </p>
                  </div>
                </label>
                ...
                <label className="flex items-start gap-3 rounded-lg border border-slate-200 bg-white px-3.5 py-3 cursor-pointer hover:border-emerald-300 hover:bg-emerald-50/30 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">
                      Credenciais e cartões de pagamento — pode remover antes de
                      salvar
                    </p>
                  </div>
                </label>
            ...
            <div className="flex gap-2.5 rounded-lg bg-blue-50 border border-blue-100 px-3.5 py-3">
              ...
              <p className="text-xs text-blue-700 leading-relaxed">
                ...
                poderá editar e remover qualquer informação na tela de criação.
              </p>
            </div>
          </div>
