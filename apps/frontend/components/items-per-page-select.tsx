        ...
        <TooltipTrigger asChild>
          <div className="items-per-page-select flex items-center gap-1.5 whitespace-nowrap">
            ...
            <Select value={value} onValueChange={onValueChange}>
              <SelectTrigger className="h-9 w-[4.5rem] rounded-lg border-0 px-3 text-xs font-semibold text-white transition-opacity hover:opacity-90 focus:ring-0 focus:ring-offset-0 btn-brand">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
