              ...
              <>
                ...
                <div className="border-t border-gray-200 p-4 bg-gray-50 flex gap-2">
                  ...
                  <Button
                    ...
                    disabled={selectedProducts.length === 0}
                    className="flex-1 h-10 text-xs bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold"
                  >
        ...
        <DialogContent className="max-w-lg max-h-[90vh] flex flex-col gap-0 p-0 overflow-hidden">
          ...
          <div className="px-6 pt-5 pb-4 border-b border-slate-100 shrink-0">
            ...
            <DialogDescription className="text-xs text-slate-500 mt-0.5">
              Confira todos os itens antes de avançar. Você pode salvar como rascunho ou exportar a proposta.
            </DialogDescription>
          </div>
          ...
          <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                <div>
                  <p className="text-[10px] text-slate-400 mb-0.5">Nome</p>
                    ...
                    >
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-slate-400">
                          {product.category} · Qtd: {qty} · unit. {formatCurrency(product.finalPrice || 0)}
                        </p>
                      </div>
            ...
            <div className="rounded-xl border border-blue-200 bg-blue-50 p-4">
              <div className="flex justify-between items-center">
                <p className="text-[10px] font-bold text-blue-500 uppercase tracking-widest">Total do Projeto</p>
                <p className="text-xl font-bold text-blue-900">{formatCurrency(calculateTotal())}</p>
              </div>
              <div className="mt-2 space-y-1">
                {selectedProducts.map((p) => {
                  const qty = productQuantities[p.id] || p.quantity || 1;
                  return (
                    <div key={p.id} className="flex justify-between text-xs text-blue-700/70">
          ...
          <div className="px-6 py-4 border-t border-slate-100 shrink-0 space-y-2">
            <div className="flex gap-2">
              ...
              <Button
                ...
                title="Exportar / Imprimir proposta"
              >
            ...
            <Button
              disabled={selectedProducts.length === 0}
              className="w-full h-10 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold text-sm"
              onClick={() => {
                setShowReview(false);
