 ...
 * useConsumePendingActivation ler dentro de si mesmas, então este listener
 * fica montado uma vez em App.tsx (sempre ativo, independente da rota) e
 * abre o painel certo quando o activateKey correspondente chega.
 */
