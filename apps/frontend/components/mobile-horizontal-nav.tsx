...
const mobileNavigationConfig = {
  ...
  agencias: [
    ...
    { name: "Perfil", href: "/agency/perfil", icon: Building2 },
    {
      name: "Clientes",
    ...
    { name: "Equipe", href: "/agency/equipe", icon: Users, badge: "8" },
    { name: "Programa", href: "/agency/programa", icon: Award },
    {
      name: "Lideradas",
    ...
    { name: "Allkademy", href: "/allkademy", icon: BookOpen },
    { name: "Config", href: "/agency/configuracoes", icon: Settings },
  ],
  nomades: [
    { name: "Dashboard", href: "/nomad/dashboard", icon: LayoutDashboard },
    {
      name: "Disponíveis",
  ...
  admin: [
    ...
    { name: "Gestão", href: "/admin/produtos", icon: Package },
    { name: "Catálogo", href: "/admin/catalogo-produtos", icon: BookOpen },
...
export function MobileHorizontalNav({ onMenuClick }: MobileHorizontalNavProps) {
  ...
  const getNavigationItems = () => {
    ...
    if (accountType === "empresas") {
      ...
      return (
        mobileNavigationConfig.empresas[
          subType as keyof typeof mobileNavigationConfig.empresas
    ...
    return (
      mobileNavigationConfig[
        accountType as keyof typeof mobileNavigationConfig
      ] || mobileNavigationConfig.empresas.company
    );
  };
