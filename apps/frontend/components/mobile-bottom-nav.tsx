...
const mobileNavigationConfig = {
  ...
  agencias: [
    { name: "Início", href: "/agencia/dashboard", icon: Home },
    { name: "Projetos", href: "/agencia/projetos", icon: FolderOpen },
    { name: "Tarefas", href: "/agencia/tarefas", icon: CheckSquare },
    { name: "Financeiro", href: "/agencia/financeiro", icon: Wallet },
    { name: "Mais", href: "#", icon: MoreHorizontal, isMenu: true },
  ],
  nomades: [
    { name: "Início", href: "/nomades/dashboard", icon: Home },
  ...
  parceiro: [
    { name: "Início", href: "/parceiro/dashboard", icon: Home },
    { name: "Projetos", href: "/parceiro/projetos", icon: FolderOpen },
    { name: "Comissões", href: "/parceiro/comissoes", icon: TrendingUp },
    { name: "Saques", href: "/parceiro/saques", icon: Wallet },
    { name: "Mais", href: "#", icon: MoreHorizontal, isMenu: true },
  ],
  lider: [
    { name: "Início", href: "/lider/dashboard", icon: Home },
    { name: "Tarefas", href: "/lider/tarefas", icon: CheckSquare },
    { name: "Qualif.", href: "/lider/qualificacao", icon: Award },
    { name: "Histórico", href: "/lider/historico", icon: History },
    { name: "Mais", href: "#", icon: MoreHorizontal, isMenu: true },
  ],
  admin: [
